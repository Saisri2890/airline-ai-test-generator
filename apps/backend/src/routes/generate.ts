...
router.post('/tests', async (req, res) => {
  try {
    ...
    // Parse the Excel file to get user stories - FIXED: Use correct method name
    ...
    // Filter user stories by selected IDs - FIXED: Use correct property name
    const selectedStories = parseResult.data.filter((story: GherkinUserStory) => 
